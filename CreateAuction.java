...
public class CreateAuction
{
     ...
     */
	public static void showActiveAuctions(int creatorID, CentralAuctioningServer server)
    {
        System.out.println("=====================================================");
     ...
     */
    public static int obtainCreatorID(CentralAuctioningServer server)
    {
    ...
    public static void addNewAuction(int creatorID, CentralAuctioningServer server, Scanner reader)
    {
        System.out.println("=====================================================");
